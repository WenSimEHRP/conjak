...
macro_rules! test_group {
    ($script:expr, $method:expr) => {
        macro_rules! test {
            ($expect: expr,$value: expr) => {
                assert_eq!(
                    $expect,
                    $value.to_chinese($script, $method).unwrap()
                );
            };
        }
        ...
        macro_rules! test_err {
            ($expect: expr,$value: expr) => {
                assert_eq!(
                    Err($expect),
                    $value.to_chinese($script, $method)
                );
            };
        }
    };
...
macro_rules! test_group_naive {
    ($script:expr) => {
        macro_rules! test {
            ($expect: expr,$value: expr) => {
                assert_eq!($expect, $value.to_chinese_naive($script));
            };
        }
    };
}
...
#[test]
fn to_uppercase_low() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Upper), ChineseCountMethod::Low);
...
fn to_uppercase_ten_thousand() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Upper), ChineseCountMethod::TenThousand);
...
fn to_uppercase_middle() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Upper), ChineseCountMethod::Middle);
...
fn to_uppercase_high() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Upper), ChineseCountMethod::High);
...
#[test]
fn to_lowercase_low() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Lower { circle_as_zero: false }), ChineseCountMethod::Low);
...
fn to_lowercase_ten_thousand() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Lower { circle_as_zero: false }), ChineseCountMethod::TenThousand);
...
fn to_lowercase_middle() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Lower { circle_as_zero: false }), ChineseCountMethod::Middle);
...
fn to_lowercase_high() {
    test_group!(NumberScript::TraditionalChinese(ScriptStyle::Lower { circle_as_zero: false }), ChineseCountMethod::High);
...
#[test]
fn to_uppercase_naive() {
    test_group_naive!(NumberScript::TraditionalChinese(ScriptStyle::Upper));
    ...
    test!("負參貳柒陸捌", i16::MIN);
    test!("陸伍伍參伍", u16::MAX);
    test!("貳壹肆柒肆捌參陸肆柒", i32::MAX);
    test!("負貳壹肆柒肆捌參陸肆捌", i32::MIN);
    test!("肆貳玖肆玖陸柒貳玖伍", u32::MAX);
    test!("玖貳貳參參柒貳零參陸捌伍肆柒柒伍捌零柒", i64::MAX);
    test!("負玖貳貳參參柒貳零參陸捌伍肆柒柒伍捌零捌", i64::MIN);
    test!("壹捌肆肆陸柒肆肆零柒參柒零玖伍伍壹陸壹伍", u64::MAX);
    test!(
    ...
    test!("壹貳參點肆陸", 123.456f32);
    test!("負壹貳參點肆陸", -123.456f32);
    test!("壹貳參點肆陸", 123.456f64);
    test!("負壹貳參點肆陸", -123.456f64);

    test!(
        "參肆零貳捌貳參肆陸陸參捌伍貳捌捌伍玖捌壹壹柒零肆壹捌參肆捌肆伍壹陸玖貳伍肆肆零",
        f32::MAX
    );
    test!(
        "負參肆零貳捌貳參肆陸陸參捌伍貳捌捌伍玖捌壹壹柒零肆壹捌參肆捌肆伍壹陸玖貳伍肆肆零",
        f32::MIN
    );
